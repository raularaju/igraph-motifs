...
def read_hdf5(arquivo):
    ...
    with open(nome_csv, mode='a', newline='') as arquivo_csv:
        ...
        csv_writer.writerow(["exam_id", "lead"] + 
                             string_motif_3 + string_motif_4 + string_motif_5 +  ["duration_motif_3", "duration_motif_4", "duration_motif_5", "array_p_4", "array_p_5"])
                ...
                for subgroup_name, subgroup in top_group.items():
                    ...
                    for t in p_array_motif:
                        ...
                        if 'grafo' in subgroup:
                            ...
                            print("motifs size 4")
                            count_motif_size_4 = G_igraph.motifs_randesu(4, t[0])
                            ...
                            print("motifs size 5")
                            count_motif_size_5 = G_igraph.motifs_randesu(5, t[1])
                            ...
                            csv_writer.writerow([exam_id, subgroup_name] + 
                                                 count_motif_size_3 + count_motif_size_4 + count_motif_size_5 + [duration_motif_3, duration_motif_4, duration_motif_5] + [t[0]] + [t[1]])
                    count+=1
